...
export const getSetup = [authenticated, (req, res, next) => {
...
export const postSetup = [authenticated, (req, res, next) => {
    if (!req.session.qr) {
...
export const profile = [authenticated, (req, res, next) => {
    return res.render("profile", {
        user: req.user
    });
}];

export const logout = [authenticated, (req, res, next) => {
    req.logout();
